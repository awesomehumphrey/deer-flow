...
1. **RMIT terms and conditions (with Black Mirror connection)**: Personal experience with RMIT's and Vervoe's terms and conditions during a lecturer recruitment process (circa 2019-2020). After being asked to complete a Vervoe AI-powered assessment, I read the terms and found them troublingly broad, granting rights to use my recorded responses, facial data, and interview performance beyond the immediate recruitment purpose, potentially for AI training and algorithmic prediction. I raised concerns with the Dean, who suggested I could use any other platform as long as I provided a link to the video lecture. I chose not to continue with the application. Months later, I watched Black Mirror's "Joan Is Awful" (S6E1, June 2023) and the parallel was immediate: the same mechanism, dense terms and conditions that obtain technically-valid-but-substantively-meaningless consent, enabling algorithmic extraction and representation without real accountability. This anecdote anchors the book's argument about how values violations are embedded in everyday digital systems. Full details in `/mnt/ValuesWork/notes/anecdote-rmit-vervoe.md`. Use for Chapter 1 opening hook, Chapter 2 (honesty gap), Chapter 6 (security connection), or the Introduction.
...
3. **AIware presentation in South Korea**: Presenting "A Vision for Value-Aligned AI-Driven Systems" at AIware 2025 (co-located with ASE 2025) on Thursday 20 November 2025, the last day of the conference. The talk was scheduled at 17:06 KST in Grand Hall 1 at the Grand Walkerhill Seoul, in the "Responsible, Ethical, and Legal Dimensions of AIware" session. Only one other talk in that session addressed values. The hall was mostly empty - the end-of-day, last-day attrition. The audience looked quizzically, not understanding the issues or their importance, or perhaps just tired. Someone asked about the difference between model alignment and system alignment. The answer: imagine a user browsing at 3am, the system extracts their time and behavioural data and sends it to a model. The model might be aligned and produce a correct prediction, but the system that designed the extraction and uses the output to manipulate the user is not aligned. The model may be aligned; the system is not. Full details in `/mnt/ValuesWork/notes/anecdote-aiware-seoul.md`. Use for Introduction (opening scene), Chapter 2 (the honesty gap / confusion), Chapter 3 (inclusion gap / marginalisation of values work).
